...
class Migration(migrations.Migration):
    ...
    replaces = [
        (b'aristotle_mdr', '0001_initial'),
        (b'aristotle_mdr', '0002_auto_20150409_0656'),
        (b'aristotle_mdr', '0003_auto_20150416_0024'),
        (b'aristotle_mdr', '0004_auto_20150424_0059'),
        (b'aristotle_mdr', '0005_auto_20150526_1058'),
        (b'aristotle_mdr', '0006_remove_status_indictionary'),
        (b'aristotle_mdr', '0007_rename_description_fields'),
        (b'aristotle_mdr', '0008_auto_20151216_0339'),
        (b'aristotle_mdr', '0009_add_explicit_related_name_for_values'),
        (b'aristotle_mdr', '0010_auto_20160106_1814'),
        (b'aristotle_mdr', '0011_update_ckeditor_remove_d19_errors'),
        (b'aristotle_mdr', '0012_better_workflows'),
        (b'aristotle_mdr', '0013_concept_field_fixer_part1'),
        (b'aristotle_mdr', '0014_concept_field_fixer_part2'),
        (b'aristotle_mdr', '0015_concept_field_fixer_part3'),
        (b'aristotle_mdr', '0016_auto_20160919_1939'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_label', models.CharField(max_length=256, blank=True, null=True, help_text='Add an app for app specific help, required for concept help')),
                ('title', models.TextField(help_text='A short title for the help page')),
                ('body', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, help_text='A long help definition for an object or topic')),
                ('language', models.CharField(max_length=7, choices=[('af', 'Afrikaans'), ('ar', 'Arabic'), ('ast', 'Asturian'), ('az', 'Azerbaijani'), ('bg', 'Bulgarian'), ('be', 'Belarusian'), ('bn', 'Bengali'), ('br', 'Breton'), ('bs', 'Bosnian'), ('ca', 'Catalan'), ('cs', 'Czech'), ('cy', 'Welsh'), ('da', 'Danish'), ('de', 'German'), ('el', 'Greek'), ('en', 'English'), ('en-au', 'Australian English'), ('en-gb', 'British English'), ('eo', 'Esperanto'), ('es', 'Spanish'), ('es-ar', 'Argentinian Spanish'), ('es-mx', 'Mexican Spanish'), ('es-ni', 'Nicaraguan Spanish'), ('es-ve', 'Venezuelan Spanish'), ('et', 'Estonian'), ('eu', 'Basque'), ('fa', 'Persian'), ('fi', 'Finnish'), ('fr', 'French'), ('fy', 'Frisian'), ('ga', 'Irish'), ('gl', 'Galician'), ('he', 'Hebrew'), ('hi', 'Hindi'), ('hr', 'Croatian'), ('hu', 'Hungarian'), ('ia', 'Interlingua'), ('id', 'Indonesian'), ('io', 'Ido'), ('is', 'Icelandic'), ('it', 'Italian'), ('ja', 'Japanese'), ('ka', 'Georgian'), ('kk', 'Kazakh'), ('km', 'Khmer'), ('kn', 'Kannada'), ('ko', 'Korean'), ('lb', 'Luxembourgish'), ('lt', 'Lithuanian'), ('lv', 'Latvian'), ('mk', 'Macedonian'), ('ml', 'Malayalam'), ('mn', 'Mongolian'), ('mr', 'Marathi'), ('my', 'Burmese'), ('nb', 'Norwegian Bokmal'), ('ne', 'Nepali'), ('nl', 'Dutch'), ('nn', 'Norwegian Nynorsk'), ('os', 'Ossetic'), ('pa', 'Punjabi'), ('pl', 'Polish'), ('pt', 'Portuguese'), ('pt-br', 'Brazilian Portuguese'), ('ro', 'Romanian'), ('ru', 'Russian'), ('sk', 'Slovak'), ('sl', 'Slovenian'), ('sq', 'Albanian'), ('sr', 'Serbian'), ('sr-latn', 'Serbian Latin'), ('sv', 'Swedish'), ('sw', 'Swahili'), ('ta', 'Tamil'), ('te', 'Telugu'), ('th', 'Thai'), ('tr', 'Turkish'), ('tt', 'Tatar'), ('udm', 'Udmurt'), ('uk', 'Ukrainian'), ('ur', 'Urdu'), ('vi', 'Vietnamese'), ('zh-cn', 'Simplified Chinese'), ('zh-hans', 'Simplified Chinese'), ('zh-hant', 'Traditional Chinese'), ('zh-tw', 'Traditional Chinese')])),
        ...
        migrations.CreateModel(
            name='ConceptHelp',
            fields=[
                ('helpbase_ptr', models.OneToOneField(parent_link=True, to='aristotle_mdr.HelpBase', serialize=False, auto_created=True, primary_key=True)),
                ('concept_type', models.CharField(max_length=256)),
                ('brief', models.TextField(help_text='A short description of the concept')),
                ('offical_definition', models.TextField(blank=True, null=True, help_text='An official description of the concept, e.g. the ISO/IEC definition for an Object Class')),
                ('official_reference', models.TextField(blank=True, null=True, help_text='The reference document that describes this concept type')),
                ('official_link', models.TextField(blank=True, null=True, help_text='An link to an official source for a description of the concept')),
                ('creation_tip', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, help_text='Instructions for creating good content of this type')),
            ],
            options={
                'ordering': ('concept_type', 'app_label'),
            },
            bases=('aristotle_mdr.helpbase',),
        ),
        migrations.CreateModel(
